 ...
 */
@WebServlet(name = "BuscarSorteado", urlPatterns = {"/BuscarSorteado"})
public class BuscarSorteado extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            FilaDAO dao;
            dao = new FilaDAO();
            Usuario obj = dao.buscarSorteado();
            
            String json = "{\"nome\" : \""+obj.getNome()+"\"}";
